"""Runnable demo — Higher education (student).
...
SOURCE = os.path.join(HERE, "source_students.csv")
NEW_SOURCE = os.path.join(HERE, "new_source_students.csv")
CANONICAL = os.path.join(HERE, "canonical_student.yml")
...
def main() -> None:
    ...
    print("CanonIQ demo: Higher education (student)")
