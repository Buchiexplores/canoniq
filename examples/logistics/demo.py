"""Runnable demo — Logistics (shipment).
...
SOURCE = os.path.join(HERE, "source_shipments.csv")
NEW_SOURCE = os.path.join(HERE, "new_source_shipments.csv")
CANONICAL = os.path.join(HERE, "canonical_shipment.yml")
...
def main() -> None:
    ...
    print("CanonIQ demo: Logistics (shipment)")
