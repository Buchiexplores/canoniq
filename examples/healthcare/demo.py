"""Runnable demo — Healthcare (patient).
...
SOURCE = os.path.join(HERE, "source_patients.csv")
NEW_SOURCE = os.path.join(HERE, "new_source_patients.csv")
CANONICAL = os.path.join(HERE, "canonical_patient.yml")
...
def main() -> None:
    ...
    print("CanonIQ demo: Healthcare (patient)")
