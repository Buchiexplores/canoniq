"""Runnable demo — Finance (transaction).
...
SOURCE = os.path.join(HERE, "source_transactions.csv")
NEW_SOURCE = os.path.join(HERE, "new_source_transactions.csv")
CANONICAL = os.path.join(HERE, "canonical_transaction.yml")
...
def main() -> None:
    ...
    print("CanonIQ demo: Finance (transaction)")
